    ...
    <div className="bg-indigo-100 py-6 md:py-12">
      <div className="container px-4 mx-auto">
        <div className="text-center mx-auto">
          ...
          <button className="bg-indigo-600 text-white py-6 px-8 rounded-full text-2xl mt-6">
            Sử dụng miễn phí
          </button>
          <div className="mind-map-img-block">
            {/* <img
              src=""
              alt="mockup"
              className="shadow-md mind-map-img"
            /> */}
            <Image
              className="mind-map-img"
